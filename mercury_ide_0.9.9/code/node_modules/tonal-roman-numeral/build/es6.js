...
var NAMES_MINOR = NAMES.map(function (n) { return n.toLowerCase(); });
var REGEX = /^(IV|I{1,3}|VI{0,2}|iv|i{1,3}|vi{0,2})([^IViv]*)$/;
var NO_PROPS = { name: null, type: null };

var getNames = function (major) { return (major === false ? NAMES_MINOR : NAMES); };
 ...
 */
export var names = function (isMajor) { return getNames(isMajor).slice(); };
 ...
 * decimal(10) // => null
 */
export var decimal = function (val) { return val > 0 && val < 8 ? val : props(val).decimal || null; };
 ...
 */
export var fromDegree = function (degree, isMajor) { return getNames(isMajor)[degree - 1] || null; };
