...
,
					"patching_rect" : [ 393.0, 390.0, 43.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 333.0, 630.0, 76.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.0, 330.0, 19.0, 22.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 551.0, 510.0, 29.5, 22.0 ],
					"text" : "$2"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 66.0, 75.0, 120.0, 22.0 ],
									"text" : "substitute 4352 4096"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 315.0, 45.0, 120.0, 208.0 ],
									"text" : "Run shortkeys:\n\nmac: \ncmd+r (370)\nalt+r (2162)\nctrl+r (4210)\n\nalt+return (2044)\ncmd+return (252)\nctrl+return (4092)\nshift+return (508)\n\nwindows:\nalt gr + return (2044)\nshift + return (508)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "run" ],
									"patching_rect" : [ 66.0, 210.0, 33.0, 22.0 ],
									"text" : "t run"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 66.0, 150.0, 214.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 66.0, 120.0, 29.5, 22.0 ],
									"text" : "+"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 506.0, 256.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 441.0, 435.0, 19.0, 22.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 13,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 441.0, 303.0, 282.999999999999886, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 70.5, 390.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 153.0, 330.0, 19.0, 22.0 ],
					"text" : "t l"
				}
...
,
					"patching_rect" : [ 297.0, 510.0, 77.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 153.0, 256.0, 307.0, 22.0 ],
					"text" : "routepass init run drawto clear size write read blink_time"
				}
...
,
					"patching_rect" : [ 506.0, 226.0, 67.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 153.0, 510.0, 129.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "th.gl.editor",
						"parameter_enable" : 0
					}
,
					"text" : "js th.gl.editor #1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"midpoints" : [ 560.5, 540.5, 129.5, 540.5 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-153", 0 ],
					"midpoints" : [ 306.5, 548.0, 137.699999999999989, 548.0, 137.699999999999989, 499.0, 162.5, 499.0 ],
					"source" : [ "obj-222", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-153", 0 ],
					"midpoints" : [ 342.5, 662.0, 420.5, 662.0, 420.5, 499.0, 162.5, 499.0 ],
					"source" : [ "obj-39", 0 ]
				}
