...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 713.0, 67.0, 22.0 ],
					"text" : "channel $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 397.0, 713.0, 88.0, 22.0 ],
					"text" : "numoutputs $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 397.0, 683.0, 55.0, 22.0 ],
					"text" : "route set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 397.0, 653.0, 120.0, 22.0 ],
...
,
					...
					"patching_rect" : [ 371.0, 758.0, 213.0, 22.0 ],
					"text" : "mc.gen~ @t send-channel @chans 16",
					"wrapper_uniquekey" : "u333016320"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 371.0, 788.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 417.0, 36.0, 22.0 ],
					"text" : "defer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 315.0, 623.0, 29.5, 22.0 ],
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 154.0, 345.0, 79.0, 22.0 ],
					"text" : "r #0_args"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 154.0, 300.0, 81.0, 22.0 ],
					"text" : "s #0_args"
				}
...
,
					"patching_rect" : [ 223.0, 480.0, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 540.0, 86.0, 22.0 ],
					"text" : "r #0_name"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 154.0, 417.0, 88.0, 22.0 ],
					"text" : "s #0_name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 417.0, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 447.0, 47.0, 22.0 ],
					"text" : "receive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.5, 585.0, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 141.399999999999977, 585.0, 155.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 141.399999999999977, 623.0, 81.0, 22.0 ],
					"text" : "send~ no_src"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 163.5, 287.0, 271.5, 287.0, 271.5, 109.0, 287.5, 109.0 ],
					"order" : 0,
					"source" : [ "obj-493", 0 ]
				}
