...
, 			{
				"box" : 				{
					...
					"text" : "fx(vocoder)\n\n<carrier> default, noise, instrument name (default=noise)\n<Q> resonance 5 to 100 (default=20)\n<shape> release in ms (default=50)\n<drywet> dry wet ratio 0 - 1 (default=1)\n\n<thresh> pass bands if amplitude  is high enough (0 - 1) (default=0)\n<range> lo hi frequency of the bands (default=50 12000)"
				}
