...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 287.0, 105.0, 22.0 ],
...
, 							{
								"box" : 								{
									"id" : "obj-284",
									"items" : [ "AU DLS Synth 1", ",", "IAC Driver Bus 1", ",", "to Max 1", ",", "to Max 2", ",", "from Max 1", ",", "from Max 2" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
