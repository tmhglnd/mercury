        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 103.0, 480.0, 73.0, 22.0 ],
                    "text": "transport $1"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 103.5, 450.0, 72.0, 22.0 ],
                    "text": "r mcy_clock"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 195.0, 450.0, 19.0, 22.0 ],
                    "text": "t l"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 236.60000000000002, 210.0, 51.0, 22.0 ],
                    "text": "unjoin 2"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 60.0, 519.0, 116.0, 22.0 ],
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 262.1, 322.5, 408.5, 322.5 ],
                    "order": 0,
                    "source": [ "obj-7", 1 ]
                }
            },
