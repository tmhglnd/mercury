...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 315.0, 315.0, 150.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 15.0, 195.0, 22.0, 22.0 ],
									"text" : "t 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 52.0, 195.0, 22.0, 22.0 ],
									"text" : "t 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 52.0, 270.0, 42.0, 22.0 ],
									"text" : "gate 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 315.0, 45.0, 160.0, 127.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 315.0, 232.0, 150.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 315.0, 210.0, 150.0, 20.0 ],
									"text" : "regexp (^\\\\/.+){([^}]+)}"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 151.25, 195.0, 55.0, 22.0 ],
									"text" : "zl.slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 75.0, 239.0, 36.0, 22.0 ],
									"text" : "route"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 213.75, 195.0, 29.5, 22.0 ],
									"text" : "0 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 213.75, 240.0, 51.0, 22.0 ],
									"text" : "unjoin 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 134.550000000000011, 315.0, 151.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 120.0, 120.0, 144.0, 22.0 ],
									"text" : "regexp ^(/.+){(.+)[:>](.+)}$"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 52.0, 360.0, 30.0, 30.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 52.0, 105.099997999999999, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 481.200000000000045, 135.0, 29.5, 22.0 ],
					"text" : "t 1 l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.700000000000045, 90.0, 57.0, 22.0 ],
					"text" : "r osc_rcv"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 540.0, 373.0, 128.099998000000028, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "no_src", "int" ],
					"patching_rect" : [ 469.700000000000045, 373.0, 61.0, 22.0 ],
					"text" : "t no_src 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 511.700000000000045, 495.0, 63.0, 22.0 ],
					"text" : "metro 64n"
				}
